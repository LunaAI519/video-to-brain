...
def generate_note(
    ...
    note_parts.append(f"type: video-note")
    ...
    if ai_analysis and not ai_analysis.get("raw_analysis"):
        ...
        points = ai_analysis.get("key_points") or ai_analysis.get("core_arguments") or ai_analysis.get("participants_topics")
        if points:
    ...
    # Footer
    note_parts.append("---")
    note_parts.append("*Generated by [video-to-brain](https://github.com/LunaAI519/video-to-brain) — 手机发视频，AI变笔记*")
